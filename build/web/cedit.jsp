				...
				<div class="col-lg-12">
					<nav class="navbar navbar-expand-lg navbar-light">
						...
						<div class="btn_1 d-none d-lg-block">
							<a href="indexfirst.jsp" class="float-right">Logout</a>
						</div>
					</nav>
				</div>
			</div>
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                    <input type="text" class="form-control placeholder hide-on-focus" placeholder="Enter your customer name" pattern="[A-Za-z\ \]+" value="<%out.print(rs.getString(2));%>" title="Please enter charaters only" name="cname" required/>
                </div>
              </div>
