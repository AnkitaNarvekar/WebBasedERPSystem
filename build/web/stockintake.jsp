<%-- 
    Document   : stockintake
    Created on : 23 Jul, 2019, 6:54:06 PM
    Author     : Dell
--%>
...
<html lang="en">
  <head>
    ...
    <title>Real_state || Stock Intake</title>
        ...
        <form class="form-contact contact_form" method="post" name="form" action="" novalidate="novalidate">
          <div class="row">
            ...
            <div class="form-group mt-3">
              <button type="submit" name="submit" class="button button-contactForm">Receive</button>
            </div>  
        </form> 
        </div>
      </div>
