<%-- 
    Document   : cdisplay
    Created on : 27 Jun, 2019, 8:17:07 PM
    Author     : Dell
--%>
    ...
    <div class="container">
      <div class="d-none d-sm-block mb-5 pb-4">
        ...
        <%
            ...
            ResultSet rs=st.executeQuery("select * from tblcustomer1");
            while(rs.next())
            {
        %>
        <tr>
            ...
            <td><a href="cedit.jsp?r=<%out.print(rs.getString(1));%>">Edit</a></td>
            <td><a href="cdelete.jsp?r=<%out.print(rs.getString(1));%>" onclick="return confirm('Do you want to delete the record?');">Delete</a></td>
        </tr>
