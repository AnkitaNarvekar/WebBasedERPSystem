<%-- 
    Document   : pdisplay
    Created on : 30 Jun, 2019, 7:38:40 PM
    Author     : Dell
--%>
    ...
    <div class="container">
      <div class="d-none d-sm-block mb-5 pb-4">
        ...
        <tr>
            ...
            <td><a href="pedit.jsp?g=<%out.print(rs.getString(1));%>">Edit</a></td>
            <td><a href="pdelete.jsp?g=<%out.print(rs.getString(1));%>" onclick="return confirm('Do you want to delete the record?');">Delete</a></td>
        </tr>
