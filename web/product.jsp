<%-- 
    Document   : product
    Created on : 29 Jun, 2019, 1:32:56 PM
    Author     : Dell
--%>
  ...
  <section class="contact-section area-padding">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          <form class="form-contact contact_form" action="pinsert.jsp" method="post" id="customerForm" novalidate="novalidate">
            <div class="row">
              
              <div class="col-sm-6">
                <div class="form-group">
                    <input type="text" class="form-control placeholder hide-on-focus" placeholder="Product name" pattern="[A-Za-z\ \]+" title="Please enter charaters only" name="pname" required/>
                </div>
              </div>
            ...
            <div><a href="pdisplay.jsp">View Records</a><br/><br/></div>
            <%
